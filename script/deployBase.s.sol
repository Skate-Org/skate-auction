...
contract DeployScript is Script {
    function run() external {
        ...
        // ExecutorRegistry executorRegistryBase =
        //     ExecutorRegistry(0x4A15a66b20836AF8DB1Aa07547CDBaD77c4c6636);
        executorRegistryBase.addExecutor(
        ...
        ISkateAuctionPeriphery auctionPeripheryBase = SkateAuctionPeriphery(
            address(
                new ERC1967Proxy(
                    impl,
        ...
        console2.log('SkateNFTPeriphery: ', address(auctionPeripheryBase));
